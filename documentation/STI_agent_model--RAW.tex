...
\begin{figure}[ht]
\centering
    \includegraphics[angle=0,width=0.4\textwidth]{./figures/formation_age.pdf}
    \includegraphics[angle=0,width=0.4\textwidth]{./figures/formation_agegap.pdf}
...
\begin{figure}[ht]
\centering
    \includegraphics[angle=0,width=0.4\textwidth]{./figures/formation_riskgroup.pdf}
    \includegraphics[angle=0,width=0.4\textwidth]{./figures/formation_deficit.pdf}
...
\begin{figure}[!ht]
\centering
   \includegraphics[angle=0,width=0.8\textwidth]{./figures/IC_Hd.pdf}
...
\begin{figure}[!ht]
\centering
   \includegraphics[angle=0,width=0.8\textwidth]{./figures/IC_Tv.pdf}
